...
namespace CG_1
{
    public partial class Form1 : Form
    {
        ...
        void PrintOut() 
        {
            label1.Text = "ERROR! OUT of range!";
        }
        ...
        int[] ConvertXYZtoCMYK(double X, double Y, double Z) {
            double rX = 95.047d;
            double rY = 100d;
            double rZ = 108.883d;
            double var_X = X / rX;
            ...
            int L = Convert.ToInt32(Math.Floor(116d * FtoCMYK(var_Y) - 16d));
            int A = Convert.ToInt32(Math.Floor(500d * (FtoCMYK(var_X) - FtoCMYK(var_Y))));
            int B = Convert.ToInt32(Math.Floor(200d * (FtoCMYK(var_Y) - FtoCMYK(var_Z))));
            int[] result = new int[] { L, A, B };
            return result;
        }

        double[] ConvertCMYKtoXYZ(double L, double A, double B)
        {
            double rX = 95.047d;
            double rY = 100d;
            double rZ = 108.883d;

            double Y = CMYKtoXYZ((L + 16) / 116d) * rY;
            double X = CMYKtoXYZ(A / 500d + (L + 16) / 116d) * rX;
            double Z = CMYKtoXYZ((L + 16) / 116d - B / 200d) * rZ;
        ...
        private void Display_rgb() {
            ...
            int[] lab = ConvertXYZtoCMYK(XYZ[0], XYZ[1], XYZ[2]);
        ...
        private void Display_xyz()
        {
            ...
            panel1.BackColor = Color.FromArgb(trackRed.Value, trackGreen.Value, trackBlue.Value);
            buttonColorPicker.BackColor = panel1.BackColor;
            int[] lab = ConvertXYZtoCMYK(x, y, z);
            lab = CheackCMYK(lab);
            textBoxL.Text = lab[0].ToString();
            textBoxA.Text = lab[1].ToString();
            textBoxB.Text = lab[2].ToString();
        ...
        private void Display_CMYK()
        {
            ...
            double[] xyz = ConvertCMYKtoXYZ(l, a, b);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                c = Convert.ToInt32(textBoxL.Text);
                m = Convert.ToInt32(textBoxA.Text);
                y = Convert.ToInt32(textBoxB.Text);
            }
            catch (Exception ex)
            {
                label1.Text = "Wrong input";
            ...
            if (c < 0 || c > 100 || m < -128 || m > 128 || y < -128 || y > 128)
            {
                label1.Text = "Wrong input";
                return;
            }
